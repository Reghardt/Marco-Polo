...
var Leg_ZodSchema = z2.object({
  givenAddress: z2.string(),
  fullAddressStr: z2.string(),
  legDetails: z2.object({ name: z2.string(), value: z2.string() }).array(),
  avoidTolls: z2.boolean(),
  legStatus: z2.number()
});
...
var addressBookRouter = router({
  getAddressBook: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    ...
    const workspace = yield Workspace_model_default.findOne({ _id: new mongoose4.Types.ObjectId(ctx.workspaceId) }, { addressBook: 1 });
    return { addressBookEntries: (_a2 = workspace == null ? void 0 : workspace.addressBook) != null ? _a2 : [] };
  })),
  createAddressBookEntry: protectedProcedure.input(z3.object({
    physicalAddress: z3.string(),
    addressDescription: z3.string()
    ...
    const addressBookEntry = yield Workspace_model_default.updateOne(
      {
        _id: new mongoose4.Types.ObjectId(ctx.workspaceId)
      },
      {
        $push: { addressBook: { _id: new mongoose4.Types.ObjectId(), physicalAddress: input.physicalAddress, addressDescription: input.addressDescription } }
      }
    );
    console.log(addressBookEntry);
    return "created";
  })),
  deleteAddressBookEntry: protectedProcedure.input(z3.object({
    addressBookEntryId: z3.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    ...
    yield Workspace_model_default.updateOne(
      ...
      {
        $pull: { addressBook: { _id: new mongoose4.Types.ObjectId(input.addressBookEntryId) } }
      }
    );
    return;
  }))
...
var authRouter = router({
  loginMs: publicProcedure.input(z4.object({
    microsoftIdToken: z4.string()
      ...
      for (let i = 0; i < 10; i++) {
        ...
        if (existingUserWithNameAndTag === null) {
          user = new User_model_default(
            {
              _id: new mongoose5.Types.ObjectId(),
              accType: "MS",
...
var driverRouter = router({
  addDriver: protectedProcedure.input(z5.object({
    username: z5.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    console.log("FIRED: addDriver");
    const driver = yield Driver_model_default.findOne({ username: input.username });
    if (driver) {
      const addedDriver = yield Workspace_model_default.updateOne({ _id: new mongoose6.Types.ObjectId(ctx.workspaceId) }, { "$push": { drivers: { _id: new mongoose6.Types.ObjectId(), driverId: driver._id, accepted: false } } });
      return;
    } else {
  ...
  getDrivers: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    ...
    if (driversInWorkspace !== void 0) {
      ...
      for (let i = 0; i < driversInWorkspace.length; i++) {
        ...
        if (driver) {
          driverIds.push(new mongoose6.Types.ObjectId(driver.driverId));
        }
      }
  ...
  sendTripToDriver: protectedProcedure.input(z5.object({
    assignedDriverId: z5.string(),
    ...
    const updateRes = yield Workspace_model_default.updateOne({ _id: ctx.workspaceId }, {
      $push: {
        drivableTrips: {
          _id: new mongoose6.Types.ObjectId(),
          assignedDriverId: new mongoose6.Types.ObjectId(input.assignedDriverId),
...
var helloRouter = router({
  sayHello: publicProcedure.input(z6.object({
    hello: z6.string()
  })).query(({ input }) => {
...
var vehicleRouter = router({
  vehicleList: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    ...
    const workspace = yield Workspace_model_default.findOne(
      {
        _id: new mongoose7.Types.ObjectId(ctx.workspaceId)
      },
      {
        vehicleList: 1
      }
  ...
  createVehicle: protectedProcedure.input(z7.object({
    vehicleDescription: z7.string(),
    vehicleLicencePlate: z7.string(),
    litersPer100km: z7.number(),
    additionalCost: z7.number(),
    additionalCostType: z7.number(),
    vehicleClass: z7.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    ...
    const newVehicle = yield Workspace_model_default.updateOne(
      ...
      {
        $push: { vehicleList: {
          _id: new mongoose7.Types.ObjectId(),
  ...
  deleteVehicle: protectedProcedure.input(z7.object({
    vehicleId: z7.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    ...
    const deletedVehicle = yield Workspace_model_default.updateOne(
      ...
      {
        $pull: { vehicleList: { _id: new mongoose7.Types.ObjectId(input.vehicleId) } }
      }
    );
    console.log(deletedVehicle);
    return;
  })),
  setLastUsedVehicle: protectedProcedure.input(z7.object({
    vehicleId: z7.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    ...
    const updated = yield Workspace_model_default.updateOne(
      {
        _id: new mongoose7.Types.ObjectId(ctx.workspaceId),
        "members.userId": new mongoose7.Types.ObjectId(ctx.userId)
      },
      {
  ...
  getVehicleById: protectedProcedure.input(z7.object({
    vehicleId: z7.string()
    ...
    const vehicle = yield Workspace_model_default.aggregate([
      { $match: { "_id": new mongoose7.Types.ObjectId(ctx.workspaceId), "vehicleList._id": new mongoose7.Types.ObjectId(input.vehicleId) } },
      { $project: { "_id": 0, "vehicle": "$vehicleList" } },
      {
        $unwind: "$vehicle"
      },
      {
        $match: { "vehicle._id": new mongoose7.Types.ObjectId(input.vehicleId) }
      }
    ]);
    return vehicle[0];
  })),
  setFuelPrice: protectedProcedure.input(z7.object({
    fuelPrice: z7.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
...
var workspaceRouter = router({
  createWorkspace: protectedProcedure.input(z8.object({
    workspaceName: z8.string(),
    descriptionPurpose: z8.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    const workspace = new Workspace_model_default({
      _id: new mongoose8.Types.ObjectId(),
      workspaceName: input.workspaceName,
      descriptionPurpose: input.descriptionPurpose,
      members: [{
        _id: new mongoose8.Types.ObjectId(),
        userId: new mongoose8.Types.ObjectId(ctx.userId),
        role: "admin"
      }],
      tokens: 1e3
    });
  ...
  getWorkspaces: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    ...
    const userWorkspaces = yield Workspace_model_default.find(
      {
        "members.userId": new mongoose8.Types.ObjectId(ctx.userId)
      },
      {
        _id: 1,
        "workspaceName": 1,
  ...
  doesWorkspaceExist: protectedProcedure.mutation((_0) => __async(void 0, [_0], function* ({ ctx }) {
    ...
    const workspace = yield Workspace_model_default.findOne(
      {
        _id: new mongoose8.Types.ObjectId(ctx.workspaceId),
        "members.userId": new mongoose8.Types.ObjectId(ctx.userId)
      },
      {
        _id: 1,
  ...
  getMemberData: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    const members = yield Workspace_model_default.aggregate([
      {
        "$match": { "_id": new mongoose8.Types.ObjectId(ctx.workspaceId), "members.userId": new mongoose8.Types.ObjectId(ctx.userId) }
      },
      {
  ...
  setActiveWorkspace: protectedProcedure.input(z8.object({
    workspaceId: z8.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
    const workspace = yield Workspace_model_default.findOne(
      { _id: new mongoose8.Types.ObjectId(input.workspaceId), "members.userId": new mongoose8.Types.ObjectId(ctx.userId) },
      { _id: 1 }
    );
    if (workspace) {
      yield User_model_default.updateOne(
        { _id: new mongoose8.Types.ObjectId(ctx.userId) },
  ...
  inviteUserToWorkspace: protectedProcedure.input(z8.object({
    userNameAndTag: z8.string()
  })).mutation((_0) => __async(void 0, [_0], function* ({ input, ctx }) {
  ...
  getUserNameAndTag: protectedProcedure.query((_0) => __async(void 0, [_0], function* ({ ctx }) {
    const user = yield User_model_default.findById(new mongoose8.Types.ObjectId(ctx.userId));
    if (user) {
  ...
  subtractTokens: protectedProcedure.input(
    ...
    const workspaceToSubtractFrom = yield Workspace_model_default.findById(
      new mongoose8.Types.ObjectId(ctx.workspaceId),
      {
        id: 1,
        tokens: 1
      }
