...
// import { RSAddresColumIndex, RSColumnVisibility, RSDepartureAddress, RSJobHeadings, RSPreserveViewport, RSReturnAddress, RSTripDirections } from '../../../state/globalstate';
...
//   const [, R_setShortestTripDirections] = useRecoilState(RSTripDirections)
